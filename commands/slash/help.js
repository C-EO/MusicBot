...
const command = new SlashCommand()
	...
	.setRun(async (client, interaction) => {
		...
		helpEmbed.addFields(
			...
			"\n" +
			`[✨ Support Server](${ client.config.supportServer }) | [Issues](${ client.config.Issues }) | [Source](https://git.c-eo.repl.co/imperialbot/musicbot) | [Invite Me](https://discord.com/oauth2/authorize?client_id=${ client.config.clientId }&permissions=${ client.config.permissions }&scope=bot%20applications.commands%20rpc%20guild%20identify)`,
		);
